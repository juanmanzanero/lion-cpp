#ifndef SENSITIVITY_ANALYSIS_SLOW_H
#define SENSITIVITY_ANALYSIS_SLOW_H
...
class Sensitivity_analysis_slow
{
 public:
    ...
    Sensitivity_analysis_slow(const FG& fg, 
...
#include "sensitivity_analysis_slow.hpp"
